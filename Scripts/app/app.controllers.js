  ...
  function ($scope, $gameChanger, $stateParams, $globals, $filter) {
    ...
    vm.optionsRunnersGrid = {
      ...
      columns: [
        ...
        { field: "onbase.OBP", title: "OBP (On Base)", template: "#= kendo.toString(onbase.OBP, 'n3')# (#= onbase.OnBase#-#= onbase.PA#)", attributes: { "class": "text-right avgbig-cell" }, headerAttributes: { "class": "avgbig-cell" } },
        { field: "scoring.AVG", title: "AVG (Scoring Pos)", template: "#= kendo.toString(scoring.AVG, 'n3')# (#= scoring.H#-#= scoring.AB#)", attributes: { "class": "text-right avgbig-cell" }, headerAttributes: { "class": "avgbig-cell" } },
        { field: "scoring.OBP", title: "OBP (Scoring Pos)", template: "#= kendo.toString(scoring.OBP, 'n3')# (#= scoring.OnBase#-#= scoring.PA#)", attributes: { "class": "text-right avgbig-cell" }, headerAttributes: { "class": "avgbig-cell" } },
        { field: "total.AVG", title: "AVG (Total)", template: "#= kendo.toString(total.AVG, 'n3')# (#= total.H#-#= total.AB#)", attributes: { "class": "text-right avgbig-cell" }, headerAttributes: { "class": "avgbig-cell" } },
        { field: "total.OBP", title: "OBP (Total)", template: "#= kendo.toString(total.OBP, 'n3')# (#= total.OnBase#-#= total.PA#)", attributes: { "class": "text-right avgbig-cell" }, headerAttributes: { "class": "avgbig-cell" } }
      ],
      excel: {
    ...
    vm.optionsDistGrid = {
      ...
      columns: [
        { field: "player.fname", title: "Name", template: "#= player.fname# #= player.lname#", attributes: { "class": "name-cell" }, headerAttributes: { "class": "name-cell" } },
        { field: "player.num", title: "#", attributes: { "class": " text-right jersey-cell" }, headerAttributes: { "class": "jersey-cell" } },
        { field: "if", title: "Infield", attributes: { "class": "text-right stat-cell" }, headerAttributes: { "class": "stat-cell" } },
        { field: "of", title: "Outfield", attributes: { "class": "text-right stat-cell" }, headerAttributes: { "class": "stat-cell" } },
        { field: "left", title: "Left Side", attributes: { "class": "text-right stat-cell" }, headerAttributes: { "class": "stat-cell" } },
        { field: "middle", title: "Middle", attributes: { "class": "text-right stat-cell" }, headerAttributes: { "class": "stat-cell" } },
        { field: "right", title: "Right Side", attributes: { "class": "text-right stat-cell" }, headerAttributes: { "class": "stat-cell" } },
